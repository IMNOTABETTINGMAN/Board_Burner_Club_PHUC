...
def parse_args():
    ...
    parser.add_argument('--left_wheel_neutral', type=int, default=90, help='left wheel servo neutral setting')
    ...
    parser.add_argument('--camera_width', type=int, default=460, help='Picamera2 image width')
    parser.add_argument('--camera_height', type=int, default=380, help='Picamera2 image height')
    parser.add_argument('--camera_x_location', type=int, default=0, help='x location of sub image')
    parser.add_argument('--camera_y_location', type=int, default=0, help='y location of sub image')
    parser.add_argument('--camera_resolution', type=int, default=1, help='determines pixel skipping in image')
...
class PHUC_firmware:
    def __init__(self):
        ...
        #need to implement camera module
        self.camera_on = False
        self.camera_buffer = [args.camera_width, args.camera_height, 3]
        # default width of 460
        self.camera_width = args.camera_width
        # default height of 380
        ...
        self.camera_frames_per_second = args.camera_frames_per_second
        self.camera_frame_rate = 1/self.camera_frames_per_second
        ...
        self.camera_buffer = np.zeros((self.camera_height, self.camera_width), dtype=np.uint8)
    ...
    def send_camera_buffer(self, segment):
        # need to update
    ...
    def parse_user_input(self, user_input):
        ...
        # camera function
            ...
            if (user_input[2] == '1'):
                ...
                self.camera_frame_rate = int(user_input[3:])
            elif (user_input[2] == 'u'):
...
def main():
    ...
    while True:
        ...
        # Send camera buffer
        if (phuc.camera_on and ((time_passed - camera_frame_time) > phuc.camera_frame_rate)):
